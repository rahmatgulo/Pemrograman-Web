      ...
      <form action="modul/barang/proses.php?aksi=tambah" method="post">
        <div class="modal-body">
          <div class="mb-3">
            ...
            <select class=from-select name="pemasok" required>
                      ...
                      <div class="modal-body">
                        <div class="mb-3">
                          ...
                          <select class=from-select name="pemasok" required>
                            ...
                            while($row_pemasok = $result_pemasok->fetch_assoc()){?>
                            ?>  
                              <option value="<?= $row_pemasok['id_pemasok'];?>" <?= $row_pemasok['id_pemasok'] == $row_barang['id_pemasok']?'selected':'';?>><?= $row_pemasok['nama_pemasok'];?></option>   
                            <?php
                            }
                            ?>
                          </select> 
                        ...
                        <div class="mb-3">
                          ...
                          <select name="kategori" class="form-select">
                            ...
                            while($row_kategori = $result_kategori->fetch_assoc()){
                            ?>
                              <option value="<?= $row_kategori['id_kategori'];?>" <?= $row_kategori['id_kategori']==$row_barang['id_kategori']?'selected':'';?>><?= $row_kategori['nama_kategori'];?></option>
                            <?php
                            }
                            ?>
                          </select> 
